...
console_log('╔═══════════════════════════════════════════════════════════════╗\n');
console_log('║  ROI TIMING OPTIMIZATION (Maximum Envelope Method)            ║\n');
console_log('╚═══════════════════════════════════════════════════════════════╝\n\n');
...
for i = 1:length(timing_values)
    ...
    try
        ...
        console_log('%-10d | %-10.4f | %-12.4e | %-12.4e', timing_sec, roi_results.R_squared, roi_results.slope, max(abs(roi_results.strain_rate)));
