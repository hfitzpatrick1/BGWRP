%% Export PT01a Depth Profile to LAS file for WellCAD
...
% Regression window (same as run_roi_analysis.m)
...
% Spatial smoothing (20 channels = 5m, same as depth profile plot)
...
output_file = fullfile(output_dir, 'PT01a_DAS_Profile_100Hz.las');
...
fprintf(fid, 'WELL. PT01a_Recovery_100Hz:\n');
...
fprintf('  Spatial smoothing: 20 channels (5m)\n');
