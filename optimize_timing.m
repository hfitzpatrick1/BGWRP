...
fprintf('╔═══════════════════════════════════════════════════════════════╗\n');
fprintf('║  TIMING CORRECTION OPTIMIZATION (Coherence + Bourdet)         ║\n');
fprintf('╚═══════════════════════════════════════════════════════════════╝\n\n');
...
for i = 1:length(timing_values)
    ...
    try
        ...
        % Print result
        fprintf('%-10d | %-10.4f | %-12.4e | %-12.4e', timing_sec, roi_results.R_squared, roi_results.slope, roi_results.RMSE);
...
fprintf('\n');
fprintf('╔═══════════════════════════════════════════════════════════════╗\n');
fprintf('║  OPTIMAL TIMING CORRECTION FOUND                              ║\n');
fprintf('╚═══════════════════════════════════════════════════════════════╝\n\n');
...
fprintf('Running final analysis with optimal timing (%ds) and plots...\n\n', optimal_timing);
