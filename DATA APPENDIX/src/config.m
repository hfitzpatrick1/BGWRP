...
%% Base Configuration
config.base_input = fullfile(fileparts(fileparts(mfilename('fullpath'))), 'data', '_BATCH');
...
config.manual_bounds.PT01c_Recovery_100.depth_axis.min = 89;   % ~27 m
config.manual_bounds.PT01c_Recovery_100.depth_axis.max = 656;  % ~200 m
...
config.dataset_smoothing.PT01A_RECOVERY_100.regression_window_sec = 20;       % Linear regression smoothing (matches PT-01b/c)
config.dataset_smoothing.PT01A_RECOVERY_100.regression_smooth_passes = 1;     % Single pass (matches PT-01b/c)
...
config.dataset_smoothing.PT01C_RECOVERY_100.regression_window_sec = 20;       % Linear regression smoothing
config.dataset_smoothing.PT01C_RECOVERY_100.regression_smooth_passes = 1;     % Single pass
