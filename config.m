...
config.analysis_windows.PT01b_start_of_pumping.start = datetime(2023,10,31,15,23,00,00,'TimeZone','UTC');
config.analysis_windows.PT01b_start_of_pumping.end = datetime(2023,10,31,15,32,00,00,'TimeZone','UTC');
...
config.manual_bounds.PT01a_start_of_pumping.displacement_rate_line.min = -0.52;   % DAS displacement rate nm/s (subplot 2 & 3)
config.manual_bounds.PT01a_start_of_pumping.displacement_rate_line.max = -0.25;
...
config.manual_bounds.PT01c_start_of_pumping.raw_data.min = -0.2;        % Figure 1: Raw data waterfall
config.manual_bounds.PT01c_start_of_pumping.raw_data.max = 0.2;
config.manual_bounds.PT01c_start_of_pumping.displacement_rate.min = -0.5; % Figure 2: Strain rate (matches line plot)
config.manual_bounds.PT01c_start_of_pumping.displacement_rate.max = -0.25;
...
config.manual_bounds.PT01c_start_of_pumping.displacement_rate_line.min = -0.22;  % DAS displacement rate nm/s (subplot 2 & 3)
config.manual_bounds.PT01c_start_of_pumping.displacement_rate_line.max = 0.07;
...
config.manual_bounds.PT01c_recovery.displacement_rate_line.min = -0.5;  % DAS displacement rate nm/s (subplot 2 & 3)
config.manual_bounds.PT01c_recovery.displacement_rate_line.max = -0.3;
...
config.manual_bounds.PT01c_Recovery_short.raw_data.min = -0.1;        % Figure 1: Raw data waterfall
config.manual_bounds.PT01c_Recovery_short.raw_data.max = 0.3;
config.manual_bounds.PT01c_Recovery_short.displacement_rate.min = 0.05; % Figure 2: Displacement rate main colorbar
config.manual_bounds.PT01c_Recovery_short.displacement_rate.max = 0.24;
config.manual_bounds.PT01c_Recovery_short.strain.min = -0.2;          % Figure 3: Strain main colorbar
config.manual_bounds.PT01c_Recovery_short.strain.max = 0.20;
...
config.manual_bounds.PT01c_Recovery_short.head_data.max = 0.08;
...
config.manual_bounds.PT01c_Recovery_short.displacement_rate_line.min = 0;  % DAS displacement rate nm/s (subplot 2 & 3)
config.manual_bounds.PT01c_Recovery_short.displacement_rate_line.max = 0.25;
...
config.manual_bounds.PT01c_Recovery_short.head_data_strain.min = -0.1;   % Head levels ft (Figure 3 subplot 2) - monitoring wells only
config.manual_bounds.PT01c_Recovery_short.head_data_strain.max = 0.1;
...
config.manual_bounds.PT01c_Recovery_short.pw_head_strain.min = -24;     % Pumping well head levels ft (Figure 3 subplot 3)
config.manual_bounds.PT01c_Recovery_short.pw_head_strain.max = 0.05;
...
config.manual_bounds.PT01b_start_of_pumping.raw_data.max = -0.15;
config.manual_bounds.PT01b_start_of_pumping.displacement_rate.min = -0.5;
config.manual_bounds.PT01b_start_of_pumping.displacement_rate.max = -0.25;
config.manual_bounds.PT01b_start_of_pumping.strain.min = -0.4;
config.manual_bounds.PT01b_start_of_pumping.strain.max = 0.4;
...
config.manual_bounds.PT01b_start_of_pumping.displacement_rate_line.min = -0.5;
config.manual_bounds.PT01b_start_of_pumping.displacement_rate_line.max = -0.25;
...
fprintf('✓ Batch configuration loaded (PT01a_start_of_pumping, PT01b_start_of_pumping, PT01c_start_of_pumping and PT01c_recovery with corrected bounds)\n');
